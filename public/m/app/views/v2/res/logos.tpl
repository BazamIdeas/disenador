            ...
            <div class="row margin-bottom-0" ng-switch="logos.tab">
				...
				<div class="col s12" ng-switch-when="1">
                    <div class="row caja logos">
                        ...
                        <span class="back-page"  ng-click="logos.modificarSalto(false, 'guardados')" ng-show="logos.cantidad.guardados > 6"><i class="material-icons">keyboard_arrow_left</i></span>
                        
                        <div class="col s10 offset-s1">
                            <div class="row cubos-logos-cliente">

                                <div class="col s6 m4" ng-repeat="guardado in logos.guardados | limitTo: 6 : logos.salto.guardados track by guardado.idLogo">
                                    <div>
                                        <div class="overlay-combinacion" ng-click="logos.seleccionado('guardados', guardado.idLogo)"></div>
                        ...
                        <span class="next-page" ng-click="logos.modificarSalto(true, 'guardados')" ng-show="logos.cantidad.guardados > 6"><i class="material-icons">keyboard_arrow_right</i></span>
				...
				<div class="col s12" ng-switch-when="2">
                    <div class="row caja logos">
                        ...
                        <span class="back-page" ng-click="logos.modificarSalto(false, 'comprados')" ng-show="logos.cantidad.comprados > 6"><i class="material-icons">keyboard_arrow_left</i></span>
                        
                        <div class="col s10 offset-s1">
                            <div class="row cubos-logos-cliente">

                                <div class="col s6 m4" ng-repeat="comprado in logos.comprados | limitTo: 6 : logos.salto.comprados track by comprado.idLogo">
                                    <div>
                        ...
                        <span class="next-page" ng-click="logos.modificarSalto(true, 'comprados')"  ng-show="logos.cantidad.comprados > 6"><i class="material-icons">keyboard_arrow_right</i></span>
