    ...
    <div layout="row" layout-align="space-around" class="contenedor-de-logos margen_inferior">
        <div layout="row" flex="45" class="md-whiteframe-2dp scroll ">
            <div flex layout="row" layout-align="space-around" layout-wrap layout-padding class="text-center">
                <div flex="30" ng-repeat="icono in cliente.respuesta.iconos" ng-mouseenter="cliente.efectoHover($index, logo)" ng-mouseleave="cliente.efectoHover($index, icono, 'iconos')"class="contenedor_logos_proceso cliente-logo">
                    <div>
                        <md-icon class="logo_icon" md-svg-src="{{icono.url}}"></md-icon>
                        <div class="text-center" layout-padding>Empresa</div>
                    </div>
                    <md-icon class="iconos-procesos siguiente" ng-show="icono.estado">create</md-icon>
                </div>
            </div>
        </div>
        <div layout="row" flex="45" class="md-whiteframe-2dp scroll ">
