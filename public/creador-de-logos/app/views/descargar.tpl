<section class="body descargar" style="background-color: white">
    ...
    <div class="row">
        ...
        <div class="col s11 p-none">
            <div ng-show="descargar.panelSeleccionado == 1" class="row p-none" style="height: calc(100vh - 60px);display: flex;">
                ...
                <div style="background-color: #ECEFF0; height: 100%; width: 100%; display: flex; flex-flow: row; justify-content: space-around; align-items: center;">
                    ...
                    <div style="width: 50%;">
                        <div ng-repeat="formato in descargar.formatosNoSociales | filter: {'nombre': descargar.formatoSeleccionado.nombre} track by formato.nombre"
                            style="position: relative; text-align:center; height: 304px; border-radius: 10px; border: 1px solid;display: flex; justify-content: center; align-items: center; background-color: white">

                            <div ng-show="descargar.formatoSeleccionado.nombre == 'editable'" style="width: 48%;position: absolute;left: calc(49% - 23%);top: 0%;">
                                <bazam-visualizar data-svg="::descargar.base64.decode(descargar.logo.logo)" ng-if="descargar.logo.logo"></bazam-visualizar>
                            </div>

                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'papeleria'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                                <foreignObject x="-115" y="152" width="109" height="109" style="transform: rotate(-48deg);">
                                    <bazam-visualizar data-svg="::descargar.base64.decode(descargar.logo.logo)" ng-if="descargar.logo.logo"></bazam-visualizar>
                                </foreignObject>
                            </svg>
                            <img ng-show="descargar.formatoSeleccionado.nombre == 'papeleria'" src="assets/images/mockups/tarjeta.png" style="max-width:100%;     height: 290px;">
                        </div>

                        <div ng-repeat="formato in descargar.formatos track by formato.nombre" ng-show="descargar.formatoSeleccionado.nombre == formato.nombre"
                            style="position: relative; text-align:center; height: 304px; border-radius: 10px; border: 1px solid;display: flex; justify-content: center; align-items: center; background-color: white;">

                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'facebook'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 250"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'whatsapp'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'instagram'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'google-plus'" style="position: absolute; height:100%;" height="250"
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'youtube'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'twitter'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'linkedin'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'pinterest'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'telegram'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                            ...
                            <svg ng-show="descargar.formatoSeleccionado.nombre == 'vimeo'" style="position: absolute; height:100%;" height="250" viewBox="0 0 400 400"
                                preserveAspectRatio="xMinYMin meet">
                        ...
                        <div>
                            ...
                            <div ng-show="!(descargar.plan.png.valor == '1' || descargar.plan.editable.valor == '1')" style="position: relative;">
                                <button class="necesita-aumentar" style="width:49.5%; margin-top: 5px; margin-left: 0.5% !important;">DESCARGAR {{descargar.formatoSeleccionado.nombre | uppercase}} ({{descargar.formatoSeleccionado.ancho}}
                                    x {{descargar.formatoSeleccionado.ancho}})
            ...
            <div ng-show="descargar.panelSeleccionado == 3" class="row p-none" class="row p-none" style="height: calc(100vh - 60px);display: flex;">
                <div class="categorias-papeleria">
                ...
                <div style="background-color: #ECEFF0; height: 100%; width: 100%; display: flex; flex-flow: row; justify-content: space-around; align-items: center;"
                    ng-switch="descargar.documentosEjemplosMostrar">
                    <div class="ejemplo-documento" ng-switch-default>
                        <img style="    width: 80%; display: block; margin:  10px auto;" src="assets/images/descarga/ejemplo-manual.jpg" </div>
            ...
            <div ng-show="descargar.panelSeleccionado == 4" class="row p-none" style="height: 100vh;">
                <div class="col-s12 p-none">
                    <div class="row p-none">
                        <bazam-crear-papeleria mostrar-planes-superiores="descargar.mostrarPlanesSuperiores" plan-bajo="descargar.planBajo" class="pagina-descargar"
                            id-logo="descargar.logo.id" estado="true" ></bazam-crear-papeleria>
                    </div>
                </div>
            </div>
