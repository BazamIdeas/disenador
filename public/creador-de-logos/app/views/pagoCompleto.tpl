    ...
    <div class="row margin-bottom-0" style="overflow: hidden;" ng-if="::pagoCompleto.logo.logo">
        ...
        <div class="col l4 offset-l4 xl4 offset-xl4" style="padding: 50px 40px 0 40px; text-align: center;">
            ...
            <div ng-if="pagoCompleto.atributos.padre && pagoCompleto.atributos.calificacion === false" ng-form="pagoCompleto.calificacionForm">
                ...
                <button class="boton-verde" ng-click="pagoCompleto.calificar(pagoCompleto.calificacionTentativa, pagoCompleto.comentario, pagoCompleto.calificacionForm.$valid);pagoCompleto.calificacionForm.$setSubmitted()"
                    type="submit">CALIFICAR</button>


            </div>

            <button ng-if="!pagoCompleto.atributos.padre || (pagoCompleto.atributos.padre && pagoCompleto.atributos.calificacion)" class="boton-verde"
                ui-sref="logos">Ver mis logos</button>
