...
<div layout layout-fill id="Previsu">
    ...
    <div class="contenedor-editor" id="popupContainer-editor">
        <div class="botones-editor">
            ...
            <div>
                <md-button class="md-fab md-primary" ng-click="editor.gLogo( null, 'Editable', editor.codificar(editor.svgFinal), editor.logo.icono.tipo, editor.logo.icono.idElemento)">
