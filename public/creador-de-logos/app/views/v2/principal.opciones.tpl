                    <div class="row margin-bottom-0 lienzo scrollbar-dynamic" data-jquery-scrollbar="$parent.principal.jqueryScrollbarOptions">
                        ...
                        <div class="col l12 xl9">
                            ...
                            <div bazam-ayuda data-texto="Selecciona tres iconos de tu gusto" data-clases="['corner-lt']" data-identificador="ayuda-iconos" data-orientacion="top" data-retraso="2500" class="row cubos-logos-opciones" ng-repeat="icono in iconos = ($parent.principal.iconos) track by icono.idElemento" ng-if="$first || (($index+1) % 4) == 0">
