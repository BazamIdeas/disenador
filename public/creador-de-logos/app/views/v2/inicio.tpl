...
<section style="max-height: calc(100vh - 135px) !important; background-color: var(--fondo);">
    <div class="row margin-bottom-0">
        ...
        <div class="contenedor-principal col l8" style="overflow: scroll;">
            <div class="row">
                <div class="col l3" style="position: relative" ng-repeat="logo in inicio.logos" ng-click="inicio.logoElegido = {svg: logo.cargado, id: $index}" fondo-contraste color="logo.icono.color">
                    <bazam-svg-text icono='{{inicio.base64.decode(logo.icono.svg)}}' url="{{logo.fuente.url}}" fuente="{{logo.fuente.nombre}}" texto="{{inicio.datos.nombre}}" callback="logo.cargado" color="{{logo.icono.color}}"></bazam-svg-text>
