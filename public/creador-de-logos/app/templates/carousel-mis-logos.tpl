    ...
    <div>
        ...
        <div class="logo-wrapper" ng-repeat="logo in logos track by logo.idLogo">
            ...
            <div class="logo-container-m" ng-class="{'logo-left-1-m': $index == (carouselMisLogos.actual - 2),'logo-left-m': $index == (carouselMisLogos.actual - 1),'logo-active-m': $index == carouselMisLogos.actual, 'logo-right-m': $index == (carouselMisLogos.actual + 1), 'logo-right-1-m': $index == (carouselMisLogos.actual + 2)}" >
                ...
                <span style="bottom: 86%" class="seleccionar"  ui-sref="editor({status: true, datos: {logo: {icono: {idElemento: logo.elementos_idElemento, svg:  logo.logo}}, idLogoGuardado: logo.idLogo, fuentes: {principal: carouselMisLogos.callback[1](logo.atributos, 'principal'), eslogan: carouselMisLogos.callback[1](logo.atributos,'eslogan')}}})" ng-if="carouselMisLogos.actual == $index && carouselMisLogos.callback[0] == 'guardados'">
                    <p>EDITAR</p> <img src="assets/images/edit_white.svg" alt="">
                </span>
                
                <span style="bottom: 86%" class="seleccionar"  ui-sref="descargar({id: logo.idLogo})" ng-if="carouselMisLogos.actual == $index && carouselMisLogos.callback[0] == 'adquiridos'">
                    <p>DESCARGAR</p> <img src="assets/images/file_download.svg" alt="">
                </span>

                <span style="bottom: 72%" class="seleccionar"  ng-click="carouselMisLogos.callback[2](logo.idLogo)" ng-if="carouselMisLogos.actual == $index && (carouselMisLogos.callback[0] == 'adquiridos' || carouselMisLogos.callback[0] == 'guardados')">
                    <p>COMPARTIR</p> <img src="assets/images/share.svg" alt="">
                </span>

                <span style="bottom: 58%" class="seleccionar"  ng-click="carouselMisLogos.callback[4]($index)" ng-if="carouselMisLogos.actual == $index && carouselMisLogos.callback[0] == 'guardados'">
                    <p>COMPRAR</p> <img src="assets/images/shop.svg" alt="">
                </span>

                <span style="bottom: 44%" class="seleccionar" ng-click="carouselMisLogos.borrarSlider(logo.idLogo)"  ng-if="carouselMisLogos.actual == $index && carouselMisLogos.callback[0] == 'guardados'">
