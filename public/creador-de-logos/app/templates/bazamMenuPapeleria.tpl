<div class="menuPapeleria {{papeleriaEditor.papeleria.tipo}}">
    <div class="tabs-p">
        ...
        <span ng-repeat="tabMenu in papeleriaEditor.papeleria.modelo.caras track by $index" class="tab tab-{{$index}}" ng-click="menuPapeleria.menuActivo = tabMenu.nombre; menuPapeleria.cambiarCara($index)"
    ...
    <div class="contenedor-principal-menu">
        <div class="contenedor-items">
            ...
            <span draggable="true" class="item" ng-repeat="item in papeleriaEditor.papeleria.items track by $index" id="{{item.nombre}}-disponible" indice="{{$index}}">
                {{item.nombre}}
            </span>
        </div>
