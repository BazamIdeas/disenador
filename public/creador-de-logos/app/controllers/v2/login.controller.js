angular.module("disenador-de-logos")
	...
	.controller("loginController", ["clientesService", "$state", "$mdToast", "$timeout", "paisesValue", "socialAutentication", function (clientesService, $state, $mdToast, $timeout, paisesValue, socialAutentication) {
			...
			bz.social = function (op) {
				...
				switch (op) {
					case 'fb':
						...
						socialAutentication.facebook().then(function (res) {
							console.log(res)
						}).catch(function (res) {
							console.log(res)
						}).finally(function () {
					...
					case 'tw':
						...
						socialAutentication.twitter().then(function (res) {
							console.log(res)
						}).catch(function (res) {
							console.log(res)
						}).finally(function () {
				...
				/* 					socialAutentication.google().then(function (res) {
										console.log(res)
									}).catch(function (res) {
										console.log(res)
									}).finally(function () {
