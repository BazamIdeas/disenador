    ...
    .directive("bazamCrearPapeleria", [function () {
        return {
            ...
            controller: ["$scope", "$mdToast", "$sce", "$stateParams", "$state", function ($scope, $mdToast, $sce, $stateParams, $state) {
                ...
                bz.enviarEditor = function(modelo){
                    bz.datos.modelo = modelo;

                    $state.go('papeleriaEditor', { id: bz.idLogo, papeleria: bz.datos});
                }
                ...
                bz.papelerias = [
                {
                    ...
                    tipo: "sobre", //tarjeta, carta, sobre
                    items: [
                        //items permitidos para esta papeleria
                        {
                            nombre: "nombre",
                    ...
                    tipo: "carta", //tarjeta, carta, sobre
                    items: [
                        //items permitidos para esta papeleria
                        {
                            nombre: "nombre",
