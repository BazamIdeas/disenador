            ...
            <div ng-switch="comenzar.mostrar">
                ...
                <div class="pasos" ng-switch-when="3" layout="column" layout-align="center space-between">
                    <div layout-padding layout layout-align="space-around">
                        <md-icon class="material-icons icono_radio" style="width: 100px; height: 100px;" md-svg-src="public/creador-de-logos/assets/iconos_temporales/Imagen2.svg"></md-icon> 
                        <md-icon class="material-icons icono_radio" style="width: 100px; height: 100px;" md-svg-src="public/creador-de-logos/assets/iconos_temporales/Imagen1.svg"></md-icon>
                    </div>
